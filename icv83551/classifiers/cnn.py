...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        pool_height = H // 2
        pool_width = W // 2
        flat_input_dim = num_filters * pool_height * pool_width

        self.params['W2'] = weight_scale * np.random.randn(flat_input_dim, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        # loss and gradient of scores
        loss, dscores = softmax_loss(scores, y)

        # L2 Regularization to loss (0.5 * reg * sum(W^2))
